              ...
              <div className='max-w-[504px] min-h-[474px] lg:mb-5'>
                ...
                <ul className='text-[black] font-semibold font-title text-[18px] mt-10'>
                  {list?.map((value, index)=>{
                    return <li key={value} className='flex items-center before:rotate-45 before:rounded-full before:mr-3 before:min-h-[8px] before:min-w-[8px] before:h-[8px] before:w-[8px] before:bg-orange mt-6'>{value}</li>
                  })}
                </ul>
              </div>
